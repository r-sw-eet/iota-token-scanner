...
**Brand resolved 2026-04-18 as CLAWNERA** — the marketplace brand of GitHub user \`Moron1337\`. Decisive evidence: \`clawnera-bot-market\` README (MIT-licensed, v0.1.97 of 2026-04-15) embeds the exact on-chain type \`0x7a38b9af…::claw_coin::CLAW_COIN\` of Studio 0a0d's \`claw_coin\` package. The repo's workflow (seller / buyer / request-buyer / request-seller / reviewer / operator + listings + bids + orders + juror voting + dispute evidence) maps module-for-module to this package's signature.
