...
export const virtue: ProjectDefinition = {
  ...
  attribution: `
On-chain evidence: four hardcoded package addresses from Virtue's public docs (\`docs.virtue.money/resources/technical-resources\`) — Framework \`0x7400af4…083b\`, VUSD Treasury \`0xd3b63e6…904f\` (ships the VUSD coin type literally), Oracle \`0x7eebbee…c2cf\`, CDP \`0x34fa327…dd22\`.
...
export const virtueStabilityPool: ProjectDefinition = {
  ...
  attribution: `
On-chain evidence: Move package with both \`balance_number\` and \`stability_pool\` modules. This is the 5th Virtue canonical component (Stability Pool at \`0xc7ab9b9…d83b\` per the Virtue docs), kept as its own row so stability-pool events (deposits, liquidations, reward claims) don't get lumped with the other 4 core components.
