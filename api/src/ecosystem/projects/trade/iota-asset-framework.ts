...
export const iotaAssetFramework: ProjectDefinition = {
  ...
  attribution: `
On-chain evidence: Move package containing \`asset\`, \`multicontroller\`, and \`controller_proposal\` modules simultaneously. Two packages on mainnet match (16-module and 17-module variants), both deployed by the IOTA Foundation Notarization deployer \`0x56af…6c8f\`.
