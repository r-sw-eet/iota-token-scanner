...
export const poolsFinance: Team = {
  id: 'pools-finance',
  name: 'Pools Finance',
  description: 'DEX + farming on IOTA Rebased. AMM router, pools, and farming contracts. Farming contracts are published from a dedicated deployer but belong to the same team.',
