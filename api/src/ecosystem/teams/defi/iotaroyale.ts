...
export const iotaroyale: Team = {
  ...
  attribution: `
Deployer \`0x21303d10…3542\` identified as IotaRoyale via IOTA RPC \`iotax_getCoinMetadata\` on the \`irt::IRT\` coin type: returns \`name: "IotaRoyale Token"\`, \`symbol: "IRT"\`, \`iconUrl: https://iotaroyale.com/logo.png\`, description \`"Token nativo de IotaRoyale — Plataforma de juegos PvP en IOTA"\`. Product verified at \`iotaroyale.com\` (Parchís/board games), GeckoTerminal listing "IRT/vIOTA - IotaRoyale Token Price on Pools Finance", and the public launch video \`youtube.com/watch?v=6530JLNTqoU\` (Feb 2026, "IOTAROYALE lanza su token $IRT y conecta farms con $TLN").
